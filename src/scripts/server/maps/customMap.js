...
// your map will be saved to `/store/custom.json` file, move the file to `/data/maps/custom.json`
// and restart the server.
const mapData = JSON.parse(fs.readFileSync(paths_1.pathTo('data', 'maps', 'custom.json'), 'utf8'));
