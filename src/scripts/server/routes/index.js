...
function createIndex(assetsPath, adminAssetsPath) {
    ...
    function renderPage({ isPublic, style, script, production, noindex, base, socketOptions, token, local }) {
        return template({
            doctype: 'html',
    ...
    function admin(production, base, assetsBase, scriptName, socket) {
        ...
        return (req, res) => {
            try {
                ...
                res.send(renderPage({ production, base, style, script, noindex: true, socketOptions, token }));
            }
            catch (e) {
    ...
    function user(production, base, styleName, scriptName, socketOptions, noindex, local, isPublic) {
        ...
        const page = renderPage({ isPublic, production, base, style, script, socketOptions, noindex, local });
        const preload = [
