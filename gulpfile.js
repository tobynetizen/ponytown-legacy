...
const common = gulp.series(hash, rollbar, changelog, icons, shaders, assets, sassTasks);
...
const watchTests = cb => {
	...
	gulp.watch(['src/scripts/**/*.js', 'test-fixtures/**/*.txt', 'test-fixtures/**/*.png'], { debounceDelay: 1000 }, task);
	cb();
};
